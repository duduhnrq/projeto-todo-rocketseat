...
export const inputCheckboxWrappperVariants = cva(
  `
...
export const inputCheckboxVariants = cva(
  `
        appearance-none peer cursor-pointer flex items-center justify-center transition overflow-hidden
    `, {
        variants: {
            variant: {
                none: "",
...
export default function InputCheckbox({
    ...
    return (
        <label className={inputCheckboxWrappperVariants({className})}>
            <input 
                type="checkbox" 
